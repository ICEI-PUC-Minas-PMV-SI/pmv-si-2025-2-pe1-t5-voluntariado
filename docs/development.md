...
|RF-02| Permitir cadastro de instituições/ONGs com informações básicas (nome, área de atuação, contato). | Letícia e Yone | cadastro-ong.html |
...
|RF-05| Exibir informações do perfil do voluntário. | Eli e Sarah| dashboard-voluntario.html |
|RF-06| Exibir informações do perfil da instituição. | Letícia e Yone | dashboard-ong.html |
